...
{
    public class DateTimeRangeFilter : RangeFilterBase
    {
        ...
        /// <summary>
        /// Create a range filter based on DateTime values.
        /// </summary>
        ...
        public DateTimeRangeFilter(string field, DateTime? greaterThan = null, DateTime? lessThan = null, DateTime? greaterThanOrEqualTo = null, DateTime? lessThanOrEqualTo = null)
            : base(field) 
        {
            if (greaterThan == null && lessThan == null && greaterThanOrEqualTo == null && lessThanOrEqualTo == null)
                throw new ArgumentNullException("range", "DateTimeRangeFilter requires at least one of the optional paramters.");
