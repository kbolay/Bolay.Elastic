...
{
    public class IntegerRangeFilter : RangeFilterBase
    {
        ...
        /// <summary>
        /// Create a range filter based on Int64/Int32 values.
        /// </summary>
        ...
        public IntegerRangeFilter(string field, Int64? greaterThan = null, Int64? lessThan = null, Int64? greaterThanOrEqualTo = null, Int64? lessThanOrEqualTo = null) : base(field) 
        {
            if (greaterThan == null && lessThan == null && greaterThanOrEqualTo == null && lessThanOrEqualTo == null)
                throw new ArgumentNullException("range", "IntegerRangeField requires at least one of the optional paramters.");
