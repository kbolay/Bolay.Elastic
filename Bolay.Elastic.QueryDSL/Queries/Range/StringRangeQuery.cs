...
{
    public class StringRangeQuery : RangeQueryBase
    {
        ...
        public StringRangeQuery(string field, string greaterThan = null, string lessThan = null, string greaterThanOrEqualTo = null, string lessThanOrEqualTo = null)
            : base(field) 
        {
            if (greaterThan == null && lessThan == null && greaterThanOrEqualTo == null && lessThanOrEqualTo == null)
                throw new ArgumentNullException("range", "StringRangeQuery requires at least one of the optional paramters.");
