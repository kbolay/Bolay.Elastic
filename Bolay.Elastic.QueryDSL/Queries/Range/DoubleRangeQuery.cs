...
{
    public class DoubleRangeQuery : RangeQueryBase
    {
        ...
        public DoubleRangeQuery(string field, Double? greaterThan = null, Double? lessThan = null, Double? greaterThanOrEqualTo = null, Double? lessThanOrEqualTo = null)
            : base(field) 
        {
            if (greaterThan == null && lessThan == null && greaterThanOrEqualTo == null && lessThanOrEqualTo == null)
                throw new ArgumentNullException("range", "DoubleRangeQuery requires at least one of the optional paramters.");
