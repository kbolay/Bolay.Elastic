...
{
    public class GeoDistanceResponseSerializer : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            List<GeoDistanceRange> ranges = new List<GeoDistanceRange>();
            foreach (Dictionary<string, object> rangeDict in rangeDictList)
            {
                ranges.Add(new GeoDistanceRange(
            ...
            return new GeoDistanceResponse(name, ranges);
        }
