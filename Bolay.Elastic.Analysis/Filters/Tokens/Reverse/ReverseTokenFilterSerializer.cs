...
{
    internal class ReverseTokenFilterSerializer : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            ReverseTokenFilter filter = new ReverseTokenFilter(filterDict.First().Key);
        ...
        {
            if (!(value is ReverseTokenFilter))
                throw new SerializeTypeException<ReverseTokenFilter>();

            ReverseTokenFilter filter = value as ReverseTokenFilter;
