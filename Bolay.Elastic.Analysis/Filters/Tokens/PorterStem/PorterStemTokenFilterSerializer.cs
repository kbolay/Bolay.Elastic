...
{
    internal class PorterStemTokenFilterSerializer : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            PorterStemTokenFilter filter = new PorterStemTokenFilter(filterDict.First().Key);
        ...
        {
            if (!(value is PorterStemTokenFilter))
                throw new SerializeTypeException<PorterStemTokenFilter>();

            PorterStemTokenFilter filter = value as PorterStemTokenFilter;
