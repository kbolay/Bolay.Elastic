...
{
    internal class KStemTokenFilterSerializer : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
        {
            ...
            KStemTokenFilter filter = new KStemTokenFilter(filterDict.First().Key);
        ...
        {
            if (!(value is KStemTokenFilter))
                throw new SerializeTypeException<KStemTokenFilter>();

            KStemTokenFilter filter = value as KStemTokenFilter;
